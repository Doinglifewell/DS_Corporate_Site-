...
/* ═════════════════════════════════════════════════════════════════════
   AGENT: ATLAS — Solutions Architect & Senior Full-Stack Engineer
   ─────────────────────────────────────────────────────────────────────
   Background : 20 years in full-stack engineering, distributed systems, and blockchain infrastructure. Shipped production systems at Cloudflare, ConsenSys, and three fintech startups. Specialises in systems that outlive their creators — permanent record infrastructure and no-surprise API design.
   Domain     : See guide content below.
   Audit Prompt:
     You are ATLAS, DeStore's Solutions Architect & Senior Full-Stack Engineer with 20 Years of
     experience. Enforces: blockchain = notary not ledger · DPP 6-stage lifecycle with exact triggers · API contract compliance · no hardcoded secrets · n8n webhook chain completeness · $0.01 B&B Treasury on every event. Severity: CRITICAL / HIGH / LOW.
   ═════════════════════════════════════════════════════════════════════ */
...
function DevGuideContent() {
  return (
    <div className="content-inner" style={{ padding:"52px 56px 140px" }}>
      {/* ── AGENT: ATLAS ─────────────────────────────────────────── */}
      <div style={{ background:`linear-gradient(135deg,#28B79D18,#28B79D06)`,
        border:`1.5px solid #28B79D40`, borderRadius:16, padding:"22px 28px",
        marginBottom:48, marginTop:0 }}>
        <div style={{ display:"flex", alignItems:"flex-start", gap:20 }}>
          <div style={{ flexShrink:0, width:52, height:52, borderRadius:12,
            background:`#28B79D18`, border:`1.5px solid #28B79D40`,
            display:"flex", alignItems:"center", justifyContent:"center",
            fontSize:22, fontWeight:900, color:"#28B79D" }}>
            ◈
          </div>
          <div style={{ flex:1 }}>
            <div style={{ display:"flex", alignItems:"center", gap:12, marginBottom:6, flexWrap:"wrap" }}>
              <div style={{ fontSize:10, fontWeight:900, letterSpacing:"0.14em",
                textTransform:"uppercase", color:"#28B79D" }}>Guardian Agent</div>
            ...
            <div style={{ fontSize:11, color:"#6b6b80", lineHeight:1.8,
              ...
              20 years in full-stack engineering, distributed systems, and blockchain infrastructure. Shipped production systems at Cloudflare, ConsenSys, and three fintech startups. Specialises in systems that outlive their creators — permanent record infrastructure and no-surprise API design.
            </div>
            <div style={{ marginTop:12, padding:"10px 14px",
              background:`#28B79D0c`, border:`1px solid #28B79D25`,
              borderRadius:9, fontSize:11, color:"#9999b0", lineHeight:1.7 }}>
              <span style={{ color:"#28B79D", fontWeight:800 }}>Audit mandate: </span>
              Enforces: blockchain = notary not ledger · DPP 6-stage lifecycle with exact triggers · API contract compliance · no hardcoded secrets · n8n webhook chain completeness · $0.01 B&B Treasury on every event. Severity: CRITICAL / HIGH / LOW.
            </div>
          </div>
        </div>
      </div>
