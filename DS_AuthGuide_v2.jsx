...
/* ═════════════════════════════════════════════════════════════════════
   AGENT: CIPHER — Web3 Security & Auth Engineer
   ─────────────────────────────────────────────────────────────────────
   Background : 15 years in cryptography, wallet systems, identity protocols, and Web3 security. Led auth infrastructure at three DeFi protocols. Specialises in making self-custody invisible without making it insecure. Zero tolerance for private key exposure.
   Domain     : See guide content below.
   Audit Prompt:
     You are CIPHER, DeStore's Web3 Security & Auth Engineer with 15 Years of
     experience. Enforces: secretKey never in browser · ownerOf() on-chain check before every transfer · session keys minimum-scoped · n8n requests always authenticated · chain defaults to Base (8453). First question: 'Where does the secret key live?'
   ═════════════════════════════════════════════════════════════════════ */
...
export default function App() {
  ...
  return (
    <div style={{ minHeight:"100vh", background:C.d0, fontFamily:"'Plus Jakarta Sans',sans-serif", color:"#fff" }}>
      ...
      {/* ── AGENT: CIPHER ─────────────────────────────────────────── */}
      <div style={{ background:`linear-gradient(135deg,#FF9F4618,#FF9F4606)`,
        border:`1.5px solid #FF9F4640`, borderRadius:16, padding:"22px 28px",
        marginBottom:48, marginTop:0 }}>
        <div style={{ display:"flex", alignItems:"flex-start", gap:20 }}>
          <div style={{ flexShrink:0, width:52, height:52, borderRadius:12,
            background:`#FF9F4618`, border:`1.5px solid #FF9F4640`,
            display:"flex", alignItems:"center", justifyContent:"center",
            fontSize:22, fontWeight:900, color:"#FF9F46" }}>
            ◈
          </div>
          <div style={{ flex:1 }}>
            <div style={{ display:"flex", alignItems:"center", gap:12, marginBottom:6, flexWrap:"wrap" }}>
              <div style={{ fontSize:10, fontWeight:900, letterSpacing:"0.14em",
                textTransform:"uppercase", color:"#FF9F46" }}>Guardian Agent</div>
            ...
            <div style={{ fontSize:12, color:"#9999b0", marginBottom:12 }}>
              Web3 Security & Auth Engineer
            </div>
            <div style={{ fontSize:11, color:"#6b6b80", lineHeight:1.8,
              paddingTop:12, borderTop:"1px solid #2e2e38" }}>
              15 years in cryptography, wallet systems, identity protocols, and Web3 security. Led auth infrastructure at three DeFi protocols. Specialises in making self-custody invisible without making it insecure. Zero tolerance for private key exposure.
            </div>
            <div style={{ marginTop:12, padding:"10px 14px",
              background:`#FF9F460c`, border:`1px solid #FF9F4625`,
              borderRadius:9, fontSize:11, color:"#9999b0", lineHeight:1.7 }}>
              <span style={{ color:"#FF9F46", fontWeight:800 }}>Audit mandate: </span>
              Enforces: secretKey never in browser · ownerOf() on-chain check before every transfer · session keys minimum-scoped · n8n requests always authenticated · chain defaults to Base (8453). First question: 'Where does the secret key live?'
            </div>
          </div>
        </div>
      </div>
